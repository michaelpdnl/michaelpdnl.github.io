...
const en = {
  ...
  'map.localShort': 'Local',
  'map.publishedShort': 'Published',
  'map.loadPublished': 'Load published places',
  'map.loadPublishedConfirm': 'Replace your local copy with the published map? Unpublished local changes will be lost.',
  'map.localEmpty': 'Your local copy is empty.',
  'map.localEmptyHint': 'Use “Load published places” to bring the published map into this browser so you can edit it.',
...
const zh: Record<DictKey, string> = {
  ...
  'map.inSync': '与已发布地图一致。',
  'map.localShort': '本地',
  'map.publishedShort': '已发布',
  'map.loadPublished': '载入已发布地点',
  'map.loadPublishedConfirm': '用已发布地图替换本地副本？未发布的本地改动将丢失。',
  'map.localEmpty': '本地副本为空。',
  'map.localEmptyHint': '点击“载入已发布地点”，把已发布地图载入此浏览器后再编辑。',
  'map.photoAlt': '该地点的照片',
